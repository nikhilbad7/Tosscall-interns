    ...
    <body>
        ...
        <div>
            ...
            <select id="city_select">
                <option selected hidden value="">Choose Your City
                    <option>
            </select>
            <select id="type_select">
                <option selected hidden value="">Choose Your Topic</option>
            </select>
            <button id="fetchBtn">View</button>
        </div>
        <div>Live</div>
        <div>
            <table id="live_event" border="1px">
                <thead>
                    <tr>
                        <th>Topic</th>
                        <th>Initiater</th>
        ...
        <div>Over</div>
        <div>
            <table id="over_event" border="1px">
                <thead>
                    <tr>
                        <th>Topic</th>
                        <th>Initiater</th>
        ...
        <script>
            ...
            function printEventDetails(tab_id, status = 1) // status = 0 (unavailable), 1 (available),2 (accepted), 3 (live),4 (over)
            {
                ...
                data = fetchData("ajax_calls/ajax_event.php", {
                    'city': city,
                    'eventtype': type,
                    'status': status
                });
